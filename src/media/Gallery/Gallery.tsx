  ...
  return (
    <div className={`w-full h-full ${className}`}>
      <div className="flex flex-col md:flex-row h-full">
        {/* Main Image */}
        { main && (
            <div className="main-image w-full grow-[7] md:w-[60%] xl:w-[50%] md:h-full cursor-pointer" onClick={() => openLightbox(0)}
            ref={mainImageRef}
            >
              {
                mainBreakpoint ? (
        ...
        {visibleThumbs.length > 0 && (
          ...
          <div className="flex grow-[3] md:grid md:grid-cols-1 md:grid-rows-2 lg:grid-cols-2 xl:grid-cols-3 overflow-hidden">
